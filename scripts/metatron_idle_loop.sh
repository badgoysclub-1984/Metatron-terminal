...
while true; do
    ...
    ./venv/bin/python scripts/augment_z9_data.py 5 >> logs/idle_improvement.log 2>&1

    # 2. Train on augmented data
    echo ">> Training Z9 QAT model..." >> logs/idle_improvement.log
    ./venv/bin/python z9_qat_training.py augmented --steps 200 >> logs/idle_improvement.log 2>&1

    # 3. Export new Modelfile
    echo ">> Exporting Modelfile..." >> logs/idle_improvement.log
    ./venv/bin/python z9_qat_training.py export >> logs/idle_improvement.log 2>&1
